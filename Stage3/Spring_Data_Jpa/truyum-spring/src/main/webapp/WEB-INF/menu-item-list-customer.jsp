...
<body>
	<header>
		<span class="header-title">truYum</span> <img class="header-logo"
			src="truyum-logo-light.png" alt="truYum Logo"></img>
		<nav>
			<a class="nav-link" href="./menuCustomer">Menu</a> <a
				class="nav-link" href="#">Cart</a>
		</nav>
	</header>
	<article>
				...
				<tbody>
					<c:forEach items="${menu_list}" var="todo">
						<tr>
							...
							<td>
								<a class="action-link" href="#">Add to Cart</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
